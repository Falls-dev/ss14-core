...
public sealed partial class ReagentDispenserWindow : DefaultWindow
{
    ...
    public FixedPoint2 DispenceAmount { get; private set; } = 1; // WD EDIT

    public FixedPoint2 Charge // WD EDIT
    {
        get => _charge;
        private set
        {
            _charge = value;
            ChargeBar.Value = (float) value;
            CurrentCharge.Text = $"{value}/{MaxCharge}";
        }
    }

    public FixedPoint2 MaxCharge
    {
        get => _maxCharge;
        private set
        {
            _maxCharge = value;
            ChargeBar.MaxValue = (float) value;
        }
    }

    private FixedPoint2 _charge;    // WD EDIT
    private FixedPoint2 _maxCharge; // WD EDIt
    ...
    public void UpdateState(BoundUserInterfaceState state)
    {
        ...
        Charge = castState.Charge;
        MaxCharge = castState.MaxCharge;
    ...
    public void UpdateContainerInfo(
        ReagentDispenserBoundUserInterfaceState state,
        ReagentId? highlightedReagentId = null)
    {
