...
public sealed class StackSpritingOverlay : Overlay
{
    ...
    public StackSpritingOverlay()
    {
        ...
        _configurationManager.OnValueChanged(WhiteCVars.StackByOneLayer,OnStackLayerChanged,true);
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        var query = _entityManager.EntityQueryEnumerator<_White.StackSpriting.RendererStackSpriteComponent, TransformComponent>();
...
public sealed class StackSpriteAccumulator
{
    ...
    public readonly SimpleBuffer<Texture> TexturePool = new(1024*256);
...
public sealed class DrawingHandleStackSprite : IDisposable
{
    ...
    public void DrawSpriteLayer(int textureId,Vector3 drawPos,Vector3? drawCenter, Angle yaw, Angle pitch, Angle roll)
    {
        ...
        var rotTrans = Matrix4.CreateRotationX((float) yaw);
    ...
    public static Texture ExtractTexture(Texture texture, in UIBox2? subRegion, out UIBox2 sr)
    {
