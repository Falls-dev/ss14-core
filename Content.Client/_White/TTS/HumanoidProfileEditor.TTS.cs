...
public sealed partial class HumanoidProfileEditor
{
    ...
    private void UpdateTTSVoicesControls()
    {
        ...
        var voiceChoiceId = _voiceList.FindIndex(x => x.ID == Profile.WhiteHumanoidProfileExtension.VoiceId);
    ...
    private void PlayTTS()
    {
        ...
        _ttsMgr.RequestPreviewTTS(IoCManager.Resolve<IRobustRandom>().Pick(_sampleText), Profile.WhiteHumanoidProfileExtension.VoiceId);
    }
}
