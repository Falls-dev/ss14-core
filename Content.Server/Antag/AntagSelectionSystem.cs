...
#region Eligible Player Selection
    ...
    public List<EntityUid> GetEligiblePlayers(
        IEnumerable<ICommonSession> playerSessions,
        ...
        Func<EntityUid?, bool>? customExcludeCondition = null)
    {
        ...
        {
            if (IsPlayerEligible(player, antagPrototype, includeAllJobs, acceptableAntags, ignorePreferences,
                    allowNonHumanoids, customExcludeCondition))
    ...
    public List<ICommonSession> GetEligibleSessions(
        IEnumerable<ICommonSession> playerSessions,
        ProtoId<AntagPrototype> antagPrototype,
        bool ignorePreferences = false)
    {
...
#region Briefings
        ...
        SoundSpecifier? briefingSound)
    {
        ...
        ChatManager.ChatMessageToOne(ChatChannel.Server, briefing, wrappedMessage, default, false, session.Channel,
            briefingColor);
    }
