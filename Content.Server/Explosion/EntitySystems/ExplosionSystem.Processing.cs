...
public sealed partial class ExplosionSystem
{
        ...
        bool ignoreResistances) // WD
    {
        ...
        {
            ProcessEntity(uid, epicenter, damage, throwForce, id, xform, fireStacks, cause, ignoreResistances); // WD EDIT
        }
        ...
        foreach (var entity in _anchored)
        {
            ...
            ProcessEntity(entity, epicenter, damage, throwForce, id, null, fireStacks, cause, ignoreResistances); // WD EDIT
        }
        ...
        foreach (var (uid, xform) in list)
        {
            ...
            ProcessEntity(uid, epicenter, null, throwForce, id, xform, null, cause, ignoreResistances); // WD EDIT
        }
        ...
        bool ignoreResistances) // WD
    {
        ...
        {
            processed.Add(uid);
            ProcessEntity(uid, epicenter, damage, throwForce, id, xform, fireStacks, cause, ignoreResistances);
        }
        ...
        foreach (var (uid, xform) in list)
        {
            ProcessEntity(uid, epicenter, null, throwForce, id, xform, fireStacks, cause, ignoreResistances);
        }
    }
