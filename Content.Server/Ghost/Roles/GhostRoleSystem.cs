...
public sealed class GhostRoleSystem : EntitySystem
{
    ...
    [Dependency] private readonly GulagSystem _gulagSystem = default!; // WD
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GhostRoleMobSpawnerComponent, GetVerbsEvent<Verb>>(OnVerb); // TODO WD FIX
    ...
    private void JoinRaffle(ICommonSession player, uint identifier)
    {
        ...
        if (_gulagSystem.IsUserGulagged(player.UserId, out _)) // WD
            return;
