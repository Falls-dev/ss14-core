                    ...
                    if (hitscan.Reflective != ReflectType.None)
                    {
                        for (var reflectAttempt = 0; reflectAttempt < 3; reflectAttempt++)
                        {
                            ...
                            if (!_container.IsEntityOrParentInContainer(lastUser))
                            {
                                ...
                                {
                                    // WD EDIT Start
                                    var hitscanAttemptEv = new HitscanHitAttemptEvent(collide.HitEntity, gun.Target);
                                    RaiseLocalEvent(collide.HitEntity, ref hitscanAttemptEv);
                            ...
                            if (!result.HasValue) // TODO WD Fix
                            {
                                return;
                            }
