...
execution-popup-gun-initial-internal = Вы приставляете {THE($weapon)} к голове {$victim}.
execution-popup-gun-initial-external = {$attacker} приставляет {THE($weapon)} к голове {$victim}.
...
suicide-popup-gun-initial-internal = Вы направили ствол {THE($weapon)} в свой рот.
suicide-popup-gun-initial-external = {$attacker} направил ствол {THE($weapon)} в {POSS-ADJ($attacker)} свой рот.
suicide-popup-gun-complete-internal = Вы стреляете себе в голову!
suicide-popup-gun-complete-external = {$attacker} стреляет {REFLEXIVE($attacker)} в голову!
...
suicide-popup-melee-initial-internal = Вы приставляете {THE($weapon)} к горлу.
...
suicide-popup-melee-complete-external = {$attacker} перерезает {POSS-ADJ($attacker)} себе горло с помощью {THE($weapon)}!
