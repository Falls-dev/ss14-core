...
lobby-state-song-no-song-text = Ничего не играет
lobby-state-song-unknown-title = [color=dimgray]Неизвестный[/color]
lobby-state-song-unknown-artist = [color=dimgray]Неизвестного[/color]
