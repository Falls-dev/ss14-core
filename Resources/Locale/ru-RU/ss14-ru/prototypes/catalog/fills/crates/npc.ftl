...
ent-CrateNPCHamlet = { ent-CrateRodentCage }
    .desc = { ent-CrateRodentCage.desc }
    .suffix = Гамлет
ent-CrateNPCLizard = ящик с ящерицой
    .desc = Ящик, содержащий одну ящерицу.
    .suffix = { "" }
ent-CrateNPCMothroach = ящик с таракамолями
    .desc = Ящик, содержащий четыре таракамоли.
    .suffix = { "" }
ent-CrateNPCKangaroo = ящик с кенгуру
    .desc = Ящик, содержащий кенгуру.
    .suffix = { "" }
ent-CrateNPCCrab = ящик с крабом
    .desc = Ящик, содержащий три больших краба.
    .suffix = { "" }
ent-CrateNPCPuppyCorgi = ящик с щенком корги
    .desc = Ящик, содержащий одного щенка корги. Оуу...
    .suffix = { "" }
ent-CrateNPCKoboldCube = ящик кобольдовых кубиков
    .desc = Ящик, содержащий одну коробку с кубиками кобольдов.
