...
ent-CrateRestraints = ящик наручников
    ...
    .suffix = { "" }
ent-CrateSecurityBodyCamera = { ent-CrateSecgear }
    .desc = { ent-CrateSecgear.desc }
    .suffix = { "" }
ent-CrateSecurityTrackingMindshieldImplants = ящик с имплантами
    .desc = Содержит 4 импланта защиты разума и 4 отслеживающих импланта. Для открытия требуется доступ безопасности.
    .suffix = { "" }
ent-CrateSecurityBiosuit = ящик c биозащитными костюмами
    .desc = Содержит 2 костюма биологической защиты, чтобы гарантировать, что никакая болезнь не отвлечет вас от ваших обязанностей. Для открытия требуется доступ службы безопасности.
    .suffix = { "" }
