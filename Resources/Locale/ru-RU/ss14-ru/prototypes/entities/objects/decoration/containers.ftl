...
ent-ShippingContainerDonkCo = грузовой контейнер Донк Ко.
    ...
    .suffix = { "" }
ent-ShippingContainerGorlex = грузовой контейнер Горлакс Секюритиз
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. Этот контейнер принадлежит Горлакс Секюритиз, и вероятнее всего, служит для транспортировки их основного экспорта - военных преступлений.
    .suffix = { "" }
