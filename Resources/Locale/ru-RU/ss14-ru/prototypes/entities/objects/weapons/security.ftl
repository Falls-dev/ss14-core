...
ent-SciFlash = вспышка
    .desc = { ent-Flash.desc }
    .suffix = 2 заряда
ent-Truncheon = стальная дубинка
    .desc = Жёсткая дубинка со стальным сердечником, предназначенная причинять боль.
ent-SurveillanceBodyCamera = нагрудная камера
    .desc = Следи за собой! Или за другими. Или за всеми сразу. Или ни за кем. Как хочешь. Нательный камера, записывающая все, что происходит вокруг.
