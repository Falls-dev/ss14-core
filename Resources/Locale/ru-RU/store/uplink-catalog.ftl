...
uplink-emp-grenade-desc = Граната, предназначенная для выведения из строя электроники. Пригодится для нарушения коммуникаций, отключения энергетического оружия охраны и АПЦ, если вы оказались в стеснённых обстоятельствах.
...
uplink-l6-saw-bundle-desc = Культовый лёгкий пулемёт L6 в комплекте с 2 коробами патронов.
