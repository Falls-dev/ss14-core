...
uplink-e20-name = Е20
uplink-e20-desc = Таинственный двадцатигранник, через три секунды после активации происходит взрыв, радиус которого зависит от силы броска. Не поддавайтесь соблазну бездумно использовать его, так как последствия могут оказаться необратимыми.

uplink-dice-of-fate-name = Кости судьбы
uplink-dice-of-fate-desc = Игральная кость таящая в себе множество тайн. Только ваша удача будет рядом с вами когда вы активируете двадцатигранник. Каждая грань содержит свой эффект, от самых негативных до невероятных. Используйте с осторожностью!
...
uplink-clothing-thieving-gloves-desc = Незаметно воруйте из карманов и повышайте навык воровства с помощью этих новых модных перчаток, которые выглядят совсем как обычные!
...
uplink-stimpack-desc = Легендарный химикат, производимый компанией Donk Co. для Синдиката. Введя его себе, вы увеличите скорость бега и сможете быстрее восстанавливаться после оглушения в течение 30 секунд.

uplink-stimkit-name = Стимкит
uplink-stimkit-desc = Набор медикаментов, содержащий 6 стимулирующих микроинъекторов, каждый из которых вводит вам достаточное количество стимуляторов на 15 секунд.
